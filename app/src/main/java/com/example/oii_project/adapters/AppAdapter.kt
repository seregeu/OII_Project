...
class AppAdapter: ListAdapter<AppItem, RecyclerView.ViewHolder>(GridAppRecyclerCallback()) {
    ...
    class AppViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        ...
        fun bind(appItem: AppItem){
            ...
            appCover?.load(appItem.imageURL)
            appRating?.rating = appItem.rating.toFloat()
